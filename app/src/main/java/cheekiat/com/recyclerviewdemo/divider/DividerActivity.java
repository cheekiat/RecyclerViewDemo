package cheekiat.com.recyclerviewdemo.divider;
...
public class DividerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomDividerItemDecoration dividerItemDecoration = new CustomDividerItemDecoration(this, CustomDividerItemDecoration.VERTICAL,true);
        dividerItemDecoration.setDrawable(getResources().getDrawable(R.drawable.shap_divider));
